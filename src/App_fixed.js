  ...
  return (
    <div style={{ width: '100vw', height: '100vh' }}>
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0 0 10px 0', color: '#ff6b6b' }}>🧟‍♂️ Parking Zombie (Scène Complète)</h1>
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 8px 0', color: '#ffd93d' }}>🎯 Éléments de la Scène :</h3>
        <p style={{ margin: '3px 0', color: '#4ecdc4' }}>• Parking gris avec lignes blanches</p>
        <p style={{ margin: '3px 0', color: '#ff0000' }}>• Voiture rouge (côté gauche)</p>
        <p style={{ margin: '3px 0', color: '#90EE90' }}>• Zombie vert (côté droit)</p>
        <p style={{ margin: '3px 0', color: '#ffff99' }}>• Réverbère avec lumière</p>
      </div>
    </div>
  );
}
